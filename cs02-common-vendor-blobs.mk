...
PRODUCT_COPY_FILES += \
	...
	$(LOCAL_PATH)/proprietary/vendor/lib/hw/camera.hawaii.so:system/vendor/lib/hw/camera.hawaii.so \
	$(LOCAL_PATH)/proprietary/vendor/lib/hw/gralloc.default.so:system/vendor/lib/hw/gralloc.default.so \
	$(LOCAL_PATH)/proprietary/vendor/lib/hw/alsa.default.so:system/vendor/lib/hw/alsa.default.so \
	$(LOCAL_PATH)/proprietary/vendor/lib/hw/lights.goldfish.so:system/vendor/lib/hw/lights.goldfish.so \
	$(LOCAL_PATH)/proprietary/vendor/lib/hw/acoustics.default.so:system/vendor/lib/hw/acoustics.default.so \
	$(LOCAL_PATH)/proprietary/vendor/lib/hw/power.default.so:system/vendor/lib/hw/power.default.so \
	$(LOCAL_PATH)/proprietary/vendor/lib/hw/sensors.hawaii.so:system/vendor/lib/hw/sensors.hawaii.so \
	$(LOCAL_PATH)/proprietary/vendor/lib/hw/gps.goldfish.so:system/vendor/lib/hw/gps.goldfish.so \
	$(LOCAL_PATH)/proprietary/vendor/lib/hw/sensors.goldfish.so:system/vendor/lib/hw/sensors.goldfish.so \
	$(LOCAL_PATH)/proprietary/vendor/lib/hw/gralloc.hawaii.so:system/vendor/lib/hw/gralloc.hawaii.so \
	$(LOCAL_PATH)/proprietary/vendor/lib/hw/hwcomposer.hawaii.so:system/vendor/lib/hw/hwcomposer.hawaii.so \
	$(LOCAL_PATH)/proprietary/vendor/lib/hw/power.hawaii.so:system/vendor/lib/hw/power.hawaii.so \
	$(LOCAL_PATH)/proprietary/vendor/lib/hw/power.goldfish.so:system/vendor/lib/hw/power.goldfish.so \
	$(LOCAL_PATH)/proprietary/vendor/lib/hw/gps.hawaii.so:system/vendor/lib/hw/gps.hawaii.so \
	$(LOCAL_PATH)/proprietary/vendor/lib/hw/lights.hawaii.so:system/vendor/lib/hw/lights.hawaii.so \
	$(LOCAL_PATH)/proprietary/vendor/lib/hw/camera.goldfish.so:system/vendor/lib/hw/camera.goldfish.so \
